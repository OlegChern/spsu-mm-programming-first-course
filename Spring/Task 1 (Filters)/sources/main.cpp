...
int main(int argc, char *argv[])
{
    ...
    else if (argc == 2 && strcmp(argv[1], "--help") == 0)
    {
        printf(
            ...
            "|         --sobel=X      # applies sobel horizontal operator to the image  |\n"
            "|         --sobel=Y      # applies sobel vertical operator to the image    |\n"
            "|         --scharr       # applies scharr operator to the image            |\n"
            "|         --scharr=X     # applies scharr horizontal operator to the image |\n"
            "|         --scharr=Y     # applies scharr vertical operator to the image   |\n"
    ...
    else if (argc == 3 || argc == 4)
    {
        ...
        if ((output = fopen(argc == 4 ? argv[3] : "output.bmp", "wb+")) == nullptr)
        {
            printf(
