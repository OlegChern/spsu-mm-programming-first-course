...
void sort(char *, int, string *, size_t);

string *getString(int, char *);

int strCount(char *, int);

int comparator(const void *, const void *);

struct stat *getStatBuff(char *);

char *openFile(char *, size_t);
...
int main(int argc, char *argv[])
{
    if (argc == 1)
    {
        printf("Enter the path to the text file you want to sort");
        return 0;
    }
